(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();const h="Pikachu",u="#FFD700",m="ピカチュウ",g="Pikachu",v="#0025",d={forma:{macho:{normal:{datos:"pikachu_normal",imagen:"https://images.wikidexcdn.net/mwuploads/wikidex/e/e0/latest/20200214192043/Pikachu_HOME.png",variocolor:"https://img.pokemondb.net/sprites/home/shiny/1x/pikachu.png"},"Con gorra":{Original:{datos:"pikachu_gorra",imagen:"https://img.pokemondb.net/sprites/home/normal/1x/pikachu-original-cap.png"},Hoenn:{datos:"pikachu_gorra",imagen:"https://img.pokemondb.net/sprites/home/normal/1x/pikachu-hoenn-cap.png"},Sinnoh:{datos:"pikachu_gorra",imagen:"https://img.pokemondb.net/sprites/home/normal/1x/pikachu-sinnoh-cap.png"},Teselia:{datos:"pikachu_gorra",imagen:"https://img.pokemondb.net/sprites/home/normal/1x/pikachu-unova-cap.png"},Kalos:{datos:"pikachu_gorra",imagen:"https://img.pokemondb.net/sprites/home/normal/1x/pikachu-kalos-cap.png"},Alola:{datos:"pikachu_gorra",imagen:"https://img.pokemondb.net/sprites/home/normal/1x/pikachu-alola-cap.png"},Compañero:{datos:"pikachu_gorra",imagen:"https://img.pokemondb.net/sprites/home/normal/1x/pikachu-partner-cap.png"},Trotamundos:{datos:"pikachu_gorra",imagen:"https://img.pokemondb.net/sprites/home/normal/1x/pikachu-world-cap.png"}}},hembra:{datos:"pikachu_normal",imagen:"https://images.wikidexcdn.net/mwuploads/wikidex/4/40/latest/20200214185804/Pikachu_HOME_hembra.png",variocolor:"https://img.pokemondb.net/sprites/home/shiny/pikachu-f.png"},giga:{datos:"pikachu_giga",imagen:"https://images.wikidexcdn.net/mwuploads/wikidex/thumb/d/d8/latest/20191016155951/Pikachu_Gigamax.png/270px-Pikachu_Gigamax.png",variocolor:"https://img.pokemondb.net/sprites/home/shiny/1x/pikachu-gigantamax.png"},mega:{datos:"pikachu_giga",imagen:""}},info:{pikachu_normal:{tipo:["Eléctrico","Eléctrico"],altura:.4,peso:6,habilidad:[{nombre:"Electricidad Estática"},{nombre:"Otro"}],generacion:"1",categoria:"Ratón",figura:"8",huevo:["Campo","Hada"],grito:"https://images.wikidexcdn.net/mwuploads/wikidex/5/5a/latest/20200302181628/Grito_de_Pikachu_en_la_s%C3%A9ptima_generaci%C3%B3n.ogg",genero:{macho:"80",hembra:"49"},color:"Amarillo",pronunciacion:[{fonetica:"pi.ˈka.chu",zona:"España"},{fonetica:"ˈpi.ka.chu",zona:"Hispanoamérica",nota:["Nota 1","Nota 2"]}]},pikachu_gorra:{tipo:["Eléctrico"],variocolor:!1,altura:.4,peso:6,habilidad:[{nombre:"Electricidad Estática"},{nombre:"Pararrayos",oculta:!0}],generacion:"7",categoria:"Ratón",figura:"8",grito:"https://images.wikidexcdn.net/mwuploads/wikidex/5/5a/latest/20200302181628/Grito_de_Pikachu_en_la_s%C3%A9ptima_generaci%C3%B3n.ogg"},pikachu_giga:{tipo:["Eléctrico"],altura:21,habilidad:[{nombre:"Electricidad Estática"},{nombre:"Pararrayos",oculta:!0}],generacion:"8",categoria:"Ratón"}}},c={gender:[{id:"btnMacho",key:"macho",color:"azulColor",icon:"https://images.wikidexcdn.net/mwuploads/wikidex/c/cc/latest/20250104233921/Macho.svg",size:"50px"},{id:"btnHembra",key:"hembra",color:"rojoColor",icon:"https://images.wikidexcdn.net/mwuploads/wikidex/3/34/latest/20250104234028/Hembra.svg",size:"50px"}],special:[{id:"btnMega",key:"mega",color:"megaColor",icon:"https://images.wikidexcdn.net/mwuploads/wikidex/b/b5/latest/20250819100853/Megaevolución_icono.svg",size:"40px"},{id:"btnMegaX",key:"megaX",color:"megaXColor",icon:"https://images.wikidexcdn.net/mwuploads/wikidex/5/52/latest/20250913220359/Megaevolución_X_(Wikidex).svg",size:"40px"},{id:"btnMegaY",key:"megaY",color:"megaYColor",icon:"https://images.wikidexcdn.net/mwuploads/wikidex/4/45/latest/20250913220424/Megaevolución_Y_(Wikidex).svg",size:"40px"},{id:"btnGiga",key:"giga",color:"gigamaxColor",icon:"https://images.wikidexcdn.net/mwuploads/wikidex/c/c0/latest/20250913220520/Gigamax_(Wikidex).svg",size:"28px"}],toggle:[{id:"btnShiny",key:"shiny",color:"amarilloColor",icon:"https://images.wikidexcdn.net/mwuploads/wikidex/a/a5/latest/20250111221940/Variocolor_(WikiDex).svg",size:"40px"},{id:"btnTrasera",key:"trasera",color:"verdeColor",icon:"https://images.wikidexcdn.net/mwuploads/wikidex/9/9f/latest/20250914123215/Rotación_%28Wikidex%29.svg",size:"25px"}]};class p{constructor(){this.forma=d.forma,this.info=d.info,this.pokemon="Pikachu",this.activeGender="",this.activeSpecialForm="",this.isShiny=!1,this.isTrasera=!1,this.selector1=0,this.selector2=0,this.secciones1=[],this.secciones2=[],this.isSeccion1="",this.isSeccion2="",this.currentAudio=null;const e=this.getAvailableGenders();e.length>0&&(this.activeGender=e[0]),this.initializeSections()}initializeSections(){this.secciones1=this.getAvailableSections(),this.secciones1.length>0&&(this.isSeccion1=this.secciones1[0],this.secciones2=this.getAvailableSubsections(this.isSeccion1),this.secciones2.length>0&&(this.isSeccion2=this.secciones2[0]))}getAvailableGenders(){return Object.keys(this.forma).filter(e=>e==="macho"||e==="hembra").filter(e=>this.forma.hasOwnProperty(e)&&this.forma[e]!=="")}getAvailableSpecialForms(){return["mega","megaX","megaY","giga"].filter(t=>this.forma.hasOwnProperty(t)&&this.forma[t]!=="")}shouldHideSections(){return["mega","megaX","megaY","giga"].includes(this.activeSpecialForm)}getCurrentFormaNode(){if(this.activeSpecialForm&&this.forma[this.activeSpecialForm])return this.forma[this.activeSpecialForm];{const e=this.getAvailableGenders();return e.length>0&&this.activeGender?this.forma[this.activeGender]:e.length>0?(this.activeGender=e[0],this.forma[this.activeGender]):this.forma}}getAvailableSections(){const e=this.getCurrentFormaNode();if(!e||typeof e=="string")return[];const t=["mega","megaX","megaY","giga","primigenio","origen"];return e.datos!==void 0?[]:Object.keys(e).filter(i=>!t.includes(i))}getAvailableSubsections(e){const t=this.getCurrentFormaNode();if(!t||typeof t=="string")return[];const i=t[e];return!i||typeof i=="string"?[]:i.datos!==void 0?[]:Object.keys(i)}getPokemonData(){if(this.activeSpecialForm&&this.forma[this.activeSpecialForm]){const s=this.forma[this.activeSpecialForm],a=typeof s=="string"?s:s.datos;return this.info[a]||{}}const e=this.getCurrentFormaNode();if(!e)return{};if(e.datos!==void 0&&typeof e.datos=="string")return this.info[e.datos]||{};const t=e[this.isSeccion1];if(!t)return{};if(typeof t=="string")return this.info[t]||{};if(t.datos!==void 0)return this.info[t.datos]||{};const i=t[this.isSeccion2];if(i){if(typeof i=="string")return this.info[i]||{};if(i.datos!==void 0)return this.info[i.datos]||{}}return{}}getCurrentImageUrls(){if(this.activeSpecialForm&&this.forma[this.activeSpecialForm]){const s=this.forma[this.activeSpecialForm];return typeof s=="string"?{}:s}const e=this.getCurrentFormaNode();if(!e)return{};if(e.datos!==void 0)return e;const t=e[this.isSeccion1];if(!t)return{};if(typeof t=="string")return{};if(t.datos!==void 0)return t;const i=t[this.isSeccion2];return i?typeof i=="string"?{}:i:{}}buildImageSrc(){const e=this.getCurrentImageUrls();return this.isTrasera&&this.isShiny&&e.variocolorTrasera?e.variocolorTrasera:this.isTrasera&&e.trasera?e.trasera:this.isShiny&&e.variocolor?e.variocolor:e.imagen?e.imagen:""}playAudio(e){try{const t=new Audio(`public/audio/${e}`);t.play().catch(i=>{}),this.currentAudio=t}catch{}}}class f{constructor(e){this.state=e,this.initializeHTML(),this.elements=this.getElements(),this.setupEventListeners(),this.updateAll(),window.addEventListener("resize",()=>this.handleResize())}getElements(){const e={imagenPokemonCuadro:document.querySelector("#imagenPokemonCuadro"),seccion1:document.querySelector("#seccion1"),seccion2:document.querySelector("#seccion2"),seccion1Texto:document.querySelector("#seccion1Texto"),seccion2Texto:document.querySelector("#seccion2Texto"),contenedorInfo:document.querySelector("#contenedorInfo"),botonVolumen:document.querySelector("#botonVolumen")};return[...c.gender,...c.special,...c.toggle].forEach(i=>{e[i.key]=document.querySelector(`#${i.id}`)}),Object.entries({btnSec1Mas:"sec1mas",btnSec1Menos:"sec1menos",btnSec2Mas:"sec2mas",btnSec2Menos:"sec2menos"}).forEach(([i,s])=>{e[s]=document.querySelector(`#${i}`)}),e}initializeHTML(){document.querySelector("#app").innerHTML=`
    ...
    `}setupEventListeners(){var e,t,i,s,a;c.gender.forEach(o=>{var n;(n=this.elements[o.key])==null||n.addEventListener("click",()=>{this.handleGenderClick(o.key)})}),c.special.forEach(o=>{var n;(n=this.elements[o.key])==null||n.addEventListener("click",()=>{this.handleSpecialFormClick(o.key)})}),c.toggle.forEach(o=>{var n;(n=this.elements[o.key])==null||n.addEventListener("click",()=>{this.handleToggleClick(o.key)})}),(e=this.elements.sec1mas)==null||e.addEventListener("click",()=>this.navigateSection(1,1)),(t=this.elements.sec1menos)==null||t.addEventListener("click",()=>this.navigateSection(1,-1)),(i=this.elements.sec2mas)==null||i.addEventListener("click",()=>this.navigateSection(2,1)),(s=this.elements.sec2menos)==null||s.addEventListener("click",()=>this.navigateSection(2,-1)),(a=this.elements.botonVolumen)==null||a.addEventListener("click",()=>{const o=this.state.getPokemonData();if(o.grito&&o.grito.startsWith("https://")){const n=new Audio(o.grito);n.play().catch(()=>{}),this.state.currentAudio=n}})}handleVolumeClick(){const e=this.state.getPokemonData();e.grito&&this.state.playAudio(e.grito)}handleResize(){this.updateTipos()}handleGenderClick(e){this.state.getAvailableGenders().includes(e)&&(this.state.activeGender=e,this.state.selector1=0,this.state.selector2=0,this.state.initializeSections(),this.updateAll())}handleSpecialFormClick(e){this.state.activeSpecialForm=this.state.activeSpecialForm===e?"":e,this.state.selector1=0,this.state.selector2=0,this.state.initializeSections(),this.updateAll()}handleToggleClick(e){const t=this.state.getCurrentImageUrls(),i=!!t.variocolor,s=!!t.trasera||!!t.variocolorTrasera;e==="shiny"&&!i||e==="trasera"&&!s||(this.state[`is${e.charAt(0).toUpperCase()+e.slice(1)}`]=!this.state[`is${e.charAt(0).toUpperCase()+e.slice(1)}`],this.updateAll())}playAudio(e){try{const t=new Audio(e);t.play().catch(),this.currentAudio=t}catch(t){console.log(t)}}navigateSection(e,t){const i=`selector${e}`,s=`secciones${e}`;this.state[i]=(this.state[i]+t+this.state[s].length)%this.state[s].length,e===1&&(this.state.selector2=0),this.updateSections(),this.updateImage(),this.updateTipos()}updateButtonState(e,t,i,s){var n;const a=this.elements[t];if(!a)return;const o=(n=c[e])==null?void 0:n.find(r=>r.key===t);o&&(s?(a.style.pointerEvents="auto",i?(a.className=`circuloExterno ${o.color}`,a.querySelector(".circuloMedio").className="circuloMedio",a.querySelector(".circuloInterno").className=`circuloInterno ${o.color}`,a.querySelector(".iconoSVG").className="iconoSVG blanco"):(a.className="circuloExterno",a.querySelector(".circuloMedio").className=`circuloMedio ${o.color} transparente`,a.querySelector(".circuloInterno").className="circuloInterno",a.querySelector(".iconoSVG").className="iconoSVG")):(a.className="circuloExterno botonDeshabilitado",a.querySelector(".circuloMedio").className="circuloMedio grisColor",a.querySelector(".circuloInterno").className="circuloInterno",a.querySelector(".iconoSVG").className="iconoSVG deshabilitado",a.style.pointerEvents="none"))}updateSections(){if(this.state.shouldHideSections()){this.elements.seccion1.style.display="none",this.elements.seccion2.style.display="none",this.state.isSeccion1="",this.state.isSeccion2="";return}this.state.secciones1=this.state.getAvailableSections(),this.state.selector1>=this.state.secciones1.length&&(this.state.selector1=0),this.state.secciones1.length<=1?(this.elements.seccion1.style.display="none",this.state.isSeccion1=this.state.secciones1[0]||"normal"):(this.elements.seccion1.style.display="flex",this.state.isSeccion1=this.state.secciones1[this.state.selector1],this.elements.seccion1Texto.textContent=this.state.isSeccion1==="normal"?"Común":this.state.isSeccion1),this.state.secciones2=this.state.getAvailableSubsections(this.state.isSeccion1),this.state.selector2>=this.state.secciones2.length&&(this.state.selector2=0),this.state.secciones2.length<=1?(this.elements.seccion2.style.display="none",this.state.isSeccion2=this.state.secciones2[0]||""):(this.elements.seccion2.style.display="flex",this.state.isSeccion2=this.state.secciones2[this.state.selector2],this.elements.seccion2Texto.textContent=this.state.isSeccion2)}updateVolumeButton(){const e=this.state.getPokemonData(),t=this.elements.botonVolumen;e.grito?t.style.display="flex":t.style.display="none"}updateTipos(){const e=this.state.getPokemonData(),t=this.elements.contenedorInfo;if(t.innerHTML="",!(!e||Object.keys(e).length===0)){if(e.tipo&&e.tipo.length>0||e.generacion!==void 0){const i=e.tipo&&e.tipo.length>0?e.tipo.map(o=>`<img src="public/Tipo_${o}_WikiDex.svg" height="25" alt="${o}">`).join(""):"";let s="";if(e.generacion!==void 0){const n=["Primera","Segunda","Tercera","Cuarta","Quinta","Sexta","Séptima","Octava","Novena","Décima","Undécima","Duodécima"][e.generacion-1]||e.generacion;s=`
      ...
      `;if(e.altura!==void 0||e.peso!==void 0){let i='<div class="contenedorMedidas">';e.altura!==void 0&&(i+=`
        ...
        `,i+="</div>",t.innerHTML+=i}if(e.habilidad&&e.habilidad.length>0){const i=e.habilidad.filter(o=>!o.oculta),s=e.habilidad.filter(o=>o.oculta);let a='<div class="contenedorMedidas">';if(i.length>0){const o=i.map(r=>`<span>${r.nombre}</span><br>`).join(""),n=i.length===1?"Habilidad":"Habilidades";a+=`
          <div class="tarjeta">
        ...
        `}if(s.length>0){const o=s.map(r=>`<span>${r.nombre}</span><br>`).join(""),n=s.length===1?"Habilidad oculta":"Habilidades ocultas";a+=`
          <div class="tarjeta">
            <div class="tituloTarjeta">${n}</div>
            <div class="contenidoTarjeta">
              <div>${o}</div>
      ...
      `}if(e.pronunciacion&&e.pronunciacion.length>0){let i="";const s=e.pronunciacion.map(a=>{let o="";a.zona==="España"?o=' <abbr title="España">(ES)</abbr>':a.zona==="Hispanoamérica"&&(o=' <abbr title="Hispanoamérica">(HA)</abbr>');let n="";return a.nota&&a.nota.length>0&&(n=a.nota.map(r=>`<ref>${r}</ref>`).join("")),`/ ${a.fonetica} /${o}${n}`}).join("<br>");i+=`
      <div class="contenedorMedidas">
      <div class="tarjeta">
